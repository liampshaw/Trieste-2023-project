...
do
	...
	python scripts/palindrome_density_gene_level.py --fasta core-accessory-fastas/"$f"_core_genes.fa --k 6 --category core --ptu $f >> core-accessory-fastas/$f-gene-level-densities.csv
	 python scripts/palindrome_density_gene_level.py --fasta core-accessory-fastas/"$f"_accessory_genes.fa --k 6 --category accessory --ptu $f >> core-accessory-fastas/$f-gene-level-densities.csv
done < ptu-list.txt 
